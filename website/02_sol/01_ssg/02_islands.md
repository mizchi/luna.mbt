...
## Embedding Islands in MoonBit (Server-side)

For SSR apps (not SSG/Markdown), use the type-safe `ComponentRef`-based API:

```moonbit
// Auto-generated by sol generate
