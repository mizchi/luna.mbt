...
All components below use `trigger="visible"` - JavaScript only loads when scrolled into view.
...
> 💡 **Note**: Components use `trigger="visible"` (Intersection Observer) for lazy hydration.
